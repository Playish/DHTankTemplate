...
public class PlayishInput : MonoBehaviour
{
	...
	void Update()
	{
		...
		// buttona is set to a jump button
		// If you want to use this button you have to make a custom playish controller and name a button: jump
		// Simply check if buttona is true or false (buttona is true if pressed) if you want to do anything when you press the button
		buttona = device.getBoolInput("jump");

        buttonb = device.getBoolInput("attack");
